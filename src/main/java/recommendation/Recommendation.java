...
import entity.Item;
import httpClient.GitHubClient;
...
public class Recommendation {
    ...
    public List<Item> recommendItems(String userId, double lat, double lon) {
        ...
        // Step 1: get all favorited itemids. for the content-based recommendation method
        ...
        // lamda expression
        Collections.sort(keywordList, (Map.Entry<String, Integer> e1, Map.Entry<String, Integer> e2) -> {
